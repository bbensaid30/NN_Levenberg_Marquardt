...
std::string const& algo, Sdouble const& learning_rate, Sdouble const& seuil, Sdouble const& beta1, Sdouble const& beta2, int const& batch_size, Sdouble& mu, Sdouble& factor,
...
bool const tracking=false, bool const record=false,std::string const setHyperparameters="");
