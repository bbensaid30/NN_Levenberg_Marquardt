...
double const radiusBall=std::pow(10,0), int const tirageDisplay = 50, int const tirageMin=0, std::string const strategy="CostAll", double const eRelative=0.01);
...
double const beta=2, double const gamma=3, int const p=3, double const sigma=0.1, int const tirageDisplay = 50, int const tirageMin=0, std::string const strategy="CostAll", double const eRelative=0.01);
